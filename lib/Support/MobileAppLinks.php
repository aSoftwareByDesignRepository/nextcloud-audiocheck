...
namespace OCA\AudioCheck\Support;

final class MobileAppLinks
{
	public const PLAY_STORE_PACKAGE_ID = 'de.softwarebydesign.audiocheck';
	public const PLAY_STORE_URL = 'https://play.google.com/store/apps/details?id=de.softwarebydesign.audiocheck';
	public const PRODUCT_PAGE_PATH = '/en/apps/audiocheck.html#mobile-app';
	public const PRODUCT_PAGE_PATH_DE = '/de/apps/audiocheck.html#mobile-app';
	public const PRIVACY_PAGE_PATH = '/en/privacy-audiocheck-mobile.html';
	public const PRIVACY_PAGE_PATH_DE = '/de/datenschutz-audiocheck-mobile.html';
