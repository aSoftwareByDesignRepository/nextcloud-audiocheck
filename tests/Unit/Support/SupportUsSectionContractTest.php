...
final class SupportUsSectionContractTest extends TestCase {
	...
	public function testCssContractHasFocusAndReducedMotion(): void {
		...
		self::assertStringContainsString('ac-support-us', $css);
		...
		if (is_file($dedicated)) {
			...
			self::assertStringContainsString('#app-content.ac-app--admin-support-us ul.ac-support-us-page__trust', $pageCss);
			...
			self::assertMatchesRegularExpression(
				'/\.ac-support-us--page \.ac-support-us__primary\s*\{[^}]*max-width:\s*none/s',
				$pageCss,
